...
public partial class EnglishCenterDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.ClassId, e.StudentId }).HasName("PK__Class_St__48357507C132E5C5");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__Courses__C92D7187F29A64A7");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC4C5CBA22");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E4E5B87D0F").IsUnique();
